package com.example.gpos720.ExemploTEF;
...
import com.example.gpos720.ExemploImpressora.tPRNTR;
import com.example.gpos720.R;
...
public class Tef extends AppCompatActivity {
    ...
    public void ImprimaGer7(String CupomTEF) {
        ...
        if (!CupomTEF.isEmpty()) {
            ...
            while (curPos >= 0) {
                ...
                if (curPos >= 0) { // Verifique se curPos é não negativo
    ...
    private void execulteSTefVenda() {
        ...
        intentSitef.putExtra("valor", Mask.unmask(txtValorOperacao.getText().toString().trim()));
