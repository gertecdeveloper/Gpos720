...
import 'package:gpos720_flutter/activities/CodigoDeBarraV1.dart';
import 'package:gpos720_flutter/activities/imprimir.dart';
import 'package:gpos720_flutter/activities/tefs.dart';
...
class _MyHomePageState extends State<MyHomePage> {
  ...
  Future<void> _leitorMifare() async {
    try {
      await platform.invokeMethod('leitorMifare');
    } on PlatformException catch (e) {
      print(e.message);
    }
  }
  ...
  var listaNomeFuncoes = [
    ...
    {"name": "Mifare", "img": "assets/nfc.png"},
